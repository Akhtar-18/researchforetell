...
(function() {
    ...
    function eb(g) { if (S.fSDec) g[W("`eeDwdouMhrudods")](W("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { S._fTWm && S._fTWm(g) }) }
    ...
    function gb(g) {
        if (g._menuButton) g.exportEnabled ? (ga(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }), Ka(g._menuButton), g._menuButton.title = g._cultureInfo.menuText) : ua(g._menuButton);
            ...
            J(g._menuButton, "mouseover", function() { l || (ga(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColorOnHover, color: g.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && ga(g._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, g.allDOMEventHandlers, !0);
            J(g._menuButton,
                "mouseout",
                function() { l || (ga(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && ga(g._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, g.allDOMEventHandlers, !0)
        }
    ...
    function ga(g, l) { for (var v in l) g.style[v] = l[v] }

    function va(g, l, v) {
        l.getAttribute("state") || (l.style.backgroundColor = g.toolbar.itemBackgroundColor, l.style.color = g.toolbar.fontColor, l.style.border = "none", ga(l, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
    ...
    var fb = function() {
        ...
        ea = function(g, l, v) {
            ...
            for (S = F = K = J = N = 0; 0 < M.length;)
                ...
                "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) { return X(U, a.length) }));
            y = "";
        ...
        W = function(g) { for (var l = "", s = 0; s < g.length; s++) l += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(s)); return l },
    ...
    y = Oa.Chart = function() {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = ta(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        ...
                        this.allDOMEventHandlers), J(this.overlaidCanvas, "mousemove", function(a) { c._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mouseup", function(a) { c._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mousedown", function(a) {
                        c._mouseEventHandler(a);
                        ua(c._dropdownMenu)
                    }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mouseout", function(a) { c._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
                        function(a) { c._touchEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) { c._touchEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function(a) { c._touchEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function(a) { c._touchEventHandler(a) }, this.allDOMEventHandlers),
        ...
        l.prototype._initialize = function() {
            ...
            if (this.options.data) {
                for (var b = 0; b < this.options.data.length; b++)
                    if (a++, !this.options.data[b].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[b].type)) {
                        ...
                        "bubble" !== c.type && "scatter" !==
                            c.type || !c.dataPoints || (c.dataPoints.some ? c.dataPoints.some(function(a) { return a.x }) && c.dataPoints.sort(g) : c.dataPoints.sort(g));
                        this.data.push(c);
                ...
                for (b = 0; b < this.data.length; b++) {
                    if ("none" == d && "error" === this.data[b].type && window.console) { window.console.log('You cannot combine "' + c.type + '" with error chart'); return }
        ...
        l.prototype.renderElements = function() {
            ...
            this.animatedRender && this._breaksCanvasCtx && b.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 });
        ...
        l.prototype.attachPlotAreaEventHandlers = function() { this.attachEvent({ context: this, chart: this, mousedown: this._plotAreaMouseDown, mouseup: this._plotAreaMouseUp, mousemove: this._plotAreaMouseMove, cursor: this.panEnabled ? "move" : "default", capture: !0, bounds: this.plotArea }) };
                        ...
                        if (!(c < l) || n) {
                            ...
                            if (b.viewPortMin === c && e)
                                for (x = 0; x < e.length; x++)
                                    if (null === e[x] && h < c) { b.viewPortMin = h; break }
            ...
            if (f) {
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        f.sort(function(a, c) { return c.diff - a.diff });
        ...
        l.prototype.getDataPointAtXY = function(a, d, b) {
            ...
            for (b = 0; b < c.length; b++)
                if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)
                    if (e = la("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= e / 2) { d = !0; break }
        ...
        l.prototype.resetOverlayedCanvas = function() { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) };
        ...
        l.prototype._dispatchRangeEvent = function(a, d) {
            ...
            for (var e = 0; e < c.length; e++)
                ...
                for (f = 0; f <
                    this.axisY2.length; f++) b[c[e]].push({ viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum });
            else if ("axisX" === c[e])
                for (f = 0; f < this.axisX.length; f++) b[c[e]].push({ viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum });
            else if ("axisX2" === c[e])
            ...
            if (this.interactivityEnabled)
                ...
                if (d.x < b.x1 || d.x > b.x2 || d.y < b.y1 || d.y > b.y2) {
                    ...
                    for (f = 0; f < this.axisX.length; f++) this.axisX[f].crosshair && this.axisX[f].crosshair.enabled &&
                        this.axisX[f].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX[f].options }, this.axisX[f].crosshair);
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(b) && 8 > Math.abs(b) && (this.panEnabled ||
                    ...
                    for (t = 0; t < this.axisX2.length; t++) this.axisX2[t].crosshair && this.axisX2[t].crosshair.enabled && (this.axisX2[t].crosshair.hide(),
                        this.axisX2[t].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX2[t].options }, this.axisX2[t].crosshair));
                ...
                if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + b : this.plotArea.x1, y1: f ? this.plotArea.y1 + c : this.plotArea.y1, x2: e ? this.plotArea.x2 + b : this.plotArea.x2, y2: f ? this.plotArea.y2 + c : this.plotArea.y2 }, clearTimeout(p._panTimerId), p._panTimerId = setTimeout(function(c, b, e, f) {
                        return function() {
        ...
        l.prototype._zoomPanToSelectedRegion =
            function(a, d, b, c, e) {
                ...
                b = a.axesRanges;
                if (a.isValid)
                    for (c = 0; c < d.length; c++) e = b[c], d[c].setViewPortRange(e.val1, e.val2), this.syncCharts && "y" != this.zoomType && this.syncCharts(e.val1, e.val2), this.stockChart && (this.stockChart._rangeEventParameter = { stockChart: this.stockChart, source: "chart", index: this.stockChart.charts.indexOf(this), minimum: e.val1, maximum: e.val2 });
                return a.isValid
            };
        l.prototype.validateRegion = function(a, d, b, c, e) {
            ...
            for (p = 0; p < k.length; p++) {
                ...
                if (isFinite(n.dataInfo.minDiff))
                    if (r =
                        n.getApparentDifference(q, h, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && r < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && r < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || h > n.maximum)) B.push(n), m.push({ val1: q, val2: h }), t = !0;
                    else if (!e) { t = !1; break }
            }
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== D && "" !== D) {
                    ...
                    if ("stackedarea100" === n) { if (m.point.x < b.x1 || m.point.x > b.x2 || m.point.y < b.y1 - 1 || m.point.y > b.y2 + 1) continue } else if ("rangearea" === n || "rangesplinearea" === n) {
                        ...
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                                ...
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (b.stroke(), w && c.stroke()), C = !0;
                                    ...
                                    if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, x, s, b), f.push(D), z = P(z), w && f.push({ x: x, y: s, ctx: c, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness });
                        ...
                        for (x = !1, l = 0; l < m.length; l++)
                            if (u = m[l].getTime ? m[l].x.getTime() : m[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                                if ("number" !== typeof m[l].y) 0 < l && !x && (k.connectNullData ? c.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType)) && (s[s.length -
                                    ...
                                    }(m[l].indexLabel || k.indexLabel || m[l].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: m[l], dataSeries: k, point: { x: u, y: x }, direction: 0 > m[l].y === a.axisY.reversed ? 1 : -1, color: r });
                                    x = !1
                                }
                    d(s)
                }
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[f], dataSeries: h, point: { x: 0 <= r[f].y ? p : u, y: t + (l - t) / 2 }, direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, p), y1: t, x2: Math.max(u, p), y2: l }, color: c })
                            }
                    }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() :
                                ...
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: u[k], dataSeries: l, point: { x: 0 <= u[k].y ? m : D, y: n }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(D, m), y1: s, x2: Math.max(D, m), y2: C }, color: c })
                            }
                    }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: l, point: { x: 0 <= u[k].y ? m : A, y: n }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(A, m), y1: C, x2: Math.max(A, m), y2: D }, color: c })
                            }
                    }
                }
                            ...
                            if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s <
                                ...
                                if ("number" !== typeof r[g].y) h.connectNullData || (ja || d) || c(), ja = !0;
                                    ...
                                    d || ja ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || b === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, b = u, l = m.x, u = m.y, c(), f.moveTo(m.x, m.y), l = d, u = b, D = m, b = h.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(l, u), w && p.lineTo(l, u)) :
                                        (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), D = { x: l, y: u }), ja = d = !1) : (f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && c());
                                    m = { x: l, y: u };
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData || (Y || x) || d(), Y = !0;
                                    ...
                                    x || Y ? (!x && z.connectNullData ? (c.setLineDash && (z.options.nullDataLineDashType || A === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(), A = k[k.length - 1], d(), c.moveTo(u.x, u.y), k.push(A), k.push(x), A = z.nullDataLineDashType, c.setLineDash(aa)), c.lineTo(h,
                                        r), w && s.lineTo(h, r)) : (c.beginPath(), c.moveTo(h, r), w && (s.beginPath(), s.moveTo(h, r))), Y = x = !1) : (c.lineTo(h, r), w && s.lineTo(h, r), 0 == q % 250 && (d(), c.moveTo(h, r), w && s.moveTo(h, r), k.push({ x: h, y: l - ma })));
                                    u = { x: h, y: r };
                                    q < v.length - 1 && (Q !== (v[q].lineColor || y) || A !== (v[q].lineDashType || z.lineDashType)) && (d(), c.beginPath(), c.moveTo(h, r), k.push({ x: h, y: l - ma }), Q = v[q].lineColor || y, c.strokeStyle = Q, c.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType, c.setLineDash(N(A, z.lineThickness))) : (A = z.lineDashType, c.setLineDash(E))));
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], h, r, c), p.push(ma), f = P(F), w && p.push({ x: h, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    s || Y ? (!s && z.connectNullData ? (c.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), c.moveTo(l.x, l.y), k.push(u), k.push(s), u = z.nullDataLineDashType, c.setLineDash(aa)), c.lineTo(h, r), w && A.lineTo(h, r)) : (c.beginPath(), c.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))), Y = s = !1) : (c.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), c.moveTo(h, r), w && A.moveTo(h, r), k.push({ x: h, y: x - ba })));
                                    l = { x: h, y: r };
                        ...
                        if (0 < D.length)
                            for (var F = C._colorSet, t = 0; t < D.length; t++) {
                                ...
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                    ...
                                    c && m > n && (ja = m, m = n, n = ja);
                                    ja = C.dataPointIds[t];
                                    this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: t, x1: Math.min(m, n), y1: Math.min(q, h), x2: Math.max(n, m), y2: Math.max(h, q), isXYSwapped: c, stemProperties: aa, whiskerProperties: Q };
                                    y(b, Math.min(m,
        ...
        l.prototype.renderPie = function(a) {
                ...
                for (c = 0; c < m.length; c++) {
                    ...
                    if (d > b) {
                        var e = 0.07 * z * Math.cos(h[c].midAngle),
                            ...
                            p = !1;
                        if (m[c].exploded) { if (1E-9 < Math.abs(h[c].center.x - (A.x + e)) || 1E-9 < Math.abs(h[c].center.y - (A.y + f))) h[c].center.x = A.x + e * a, h[c].center.y = A.y + f * a, p = !0 } else if (0 < Math.abs(h[c].center.x - A.x) || 0 < Math.abs(h[c].center.y - A.y)) h[c].center.x = A.x + e * (1 - a), h[c].center.y = A.y + f * (1 - a),
                            p = !0;
            ...
            function e(a) {
                for (var b = null, d = 1; d < m.length; d++)
                    if (b = (a + d + h.length) % h.length, h[b].hemisphere !== h[a].hemisphere) { b = null; break } else if (h[b].indexLabelText && b !== a && (0 > c(h[b], h[a]) || ("right" === h[a].hemisphere ? h[b].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[b].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))) break;
                else b = null;
                return b
            }
            ...
            function p() {
                ...
                for (var b = a = 0, d = 0, p = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                    ...
                    var H = function(a,
                        ...
                        d.sort(function(a, c) { return a.y - c.y });
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                        ...
                        if (-1 !== H) {
                            ...
                            if (J && u.visible && (c(), f(), e(), "inside" !== u.indexLabelPlacement)) { p(); for (G = 0; G < x.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (M - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < O.length; G++) O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), I[G].textBlock.x += z }
        ...
        l.prototype.set = function(a, d, b) { b = "undefined" === typeof b ? !0 : b; "options" === a ? (this.options = d, b && this.render()) : l.base.set.call(this, a, d, b) };
        l.prototype.exportChart = function(a) {
            ...
            if (c && d && b) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    ...
                    try { window.navigator.msSaveBlob(d, b), e = !0 } catch (k) {
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "error":
                                a >=
                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (c.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), g = !0);
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "boxAndWhisker":
                                if (a >=
                                    q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) c.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), g = !0;
                                break;
                            case "candlestick":
                                if (a >= q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y2 - q.borderThickness / 2 && d <= q.y3 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness &&
                                    d >= q.y1 && d <= q.y4) c.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), g = !0;
                                break;
                            case "ohlc":
        ...
        E.prototype.convertPixelToValue = function(a) {
            ...
            if (this.logarithmic) {
                ...
                if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                    ...
                    c -= e[b].endValue - this.conversionParameters.minimum;
                    if (c > -1 * e[b].size) { a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c; break } else a -= e[b].endValue - e[b].startValue -
                        e[b].size;
                    c += e[b].size;
                    d = !1
                } else break;
                ...
                if (this.scaleBreaks)
                    for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++)
                        if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) && (!s(this.sessionVariables.newViewportMaximum) &&
                                this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue || !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[c].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue)) { this.scaleBreaks._appliedBreaks.splice(c, 1); break }
                if ("axisX" === this.type) {
        ...
        T.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (c = 1 === n % 2 ? (c.x << 0) + 0.5 : c.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c - n / 2, y1: e, x2: g + n / 2, y2: l }, this.ctx.moveTo(c,
                    ...
                    if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === n % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2,
                            g = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c, y1: e - n / 2, x2: g, y2: l + n / 2 }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(c, l);
                    else if ("wavy" === this.type) {
                    s = c;
                    k = e;
                    f = 0.5;
        ...
        $.prototype.showAt = function(a) {
            ...
            for (c = 0; c <
                d.axisY2.length; c++) a = d.axisY2[c]._crosshairValue, d.axisY2[c].crosshair && (d.axisY2[c].crosshair.enabled && !s(a) && a >= d.axisY2[c].viewportMinimum && a <= d.axisY2[c].viewportMaximum) && (d.axisY2[c].showCrosshair(a), d.axisY2[c].crosshair._updatedValue = a, this === d.axisY2[c].crosshair && (b = !0));
        ...
        $.prototype.render = function(a, d, b) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y[c] }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y[c], this.valueFormatString, this.chart._cultureInfo) : this.label
                            ...
                            this.value = A;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                            ...
                            this.value = C;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : C }) : s(this.options.label) ? ea(b ?
                                b : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, this.value = x.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        c = e = l;
                        ...
                        if (C) {
                            ...
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.x }) : s(this.options.label) ? ea(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (C) {
                        ...
                        value: x.dataPoint.x
                    }) : s(this.options.label) ? Aa(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : s(this.options.label) ? ea(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    this.value = x.dataPoint.x;
                    k.x = c - k.measureText().width / 2;
                    ...
                    for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    y = 0;
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y }) : s(this.options.label) ?
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : C }) : s(this.options.label) ? ea(b ? b : C, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = C
                        ...
                        0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataPoint.y);
                    f = g = w;
                    c = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = { x1: c, y1: f - n / 2, x2: e, y2: g + n / 2 };
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) c = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = { x1: c - n / 2, y1: f, x2: e + n / 2, y2: g };
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (v = 0; v < this.chart.axisX.length; v++)
                                for (g = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX[v].dataSeries.length; c++)(k = this.chart.axisX[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[c], null !== k.dataPoint.y && l.push(k));
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (g = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX2[v].dataSeries.length; c++)(k =
        ...
        X.prototype.show = function(a, d, b) { this._updateToolTip(a, d, "undefined" === typeof b ? !1 : b) };
        ...
        da.prototype.mouseEventHandler = function(a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
                    f = !0;
                    for (c = 0; c < d.length; c++)
                        if (d[c].id === this.mouseoveredObjectMaps[b].id) { f = !1; break }
        ...
        var K = {
                ...
                easing: { linear: function(a, d, b, c) { return b * a / c + d }, easeOutQuad: function(a, d, b, c) { return -b * (a /= c) * (a - 2) + d }, easeOutQuart: function(a, d, b, c) { return -b * ((a = a / c - 1) * a * a * a - 1) + d }, easeInQuad: function(a, d, b, c) { return b * (a /= c) * a + d }, easeInQuart: function(a, d, b, c) { return b * (a /= c) * a * a * a + d } }
            },
            V = {
