                            ...
                            <div class="card-body">
                                ...
                                <form name="upload" method="post" id="uploadForm">
                                    ...
                                    <table border="1">
                                        ...
                                        <?php if(isset($file_content[12])) { //echo "empty"; ?>
                                        <tr>
                                            <th>Global CAGR</th>
                                            <td>
                                                <!--<input type="text" name="category" value="Category" class="form-control" readonly/>-->
                                        ...
                                        <?php if(isset($file_content[13])) { //echo "empty"; ?>
                                        <tr>
                                        ...
                                        <?php if(isset($file_content[14])) { //echo "empty"; ?>
                                        <tr>
                                        ...
                                        <?php if(isset($file_content[15])) { //echo "empty"; ?>
                                        <tr>
                                            <th>Segmentation</th>
                                            <td>
                                                <!--<input type="text" name="category" value="Category" class="form-control" readonly/>-->
                                        ...
                                        <?php if(isset($file_content[16])) { //echo "empty"; ?>
                                        <tr>
                                            <th>Major Players</th>
                                            <td>
                                                <!--<input type="text" name="category" value="Category" class="form-control" readonly/>-->
