...
<body>
    ...
    <?php $this->load->view('includes/menu');?>
        ...
        <div class="container">
            ...
            <h3 class="rft-color1 text-center" style="
    font-weight: 600;
    text-transform: uppercase;
    font-size: 24px;">Contact Us</h3>
           


       
             <div class="row" style="margin-left:15px;margin-right:15px;text-align:justify;background:#f0f0f0;padding:20px;margin-bottom:25px;margin-top:25px;">
                    ...
                    <form name="contact-form" id="contact-form" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input name="yourName" id="yourName" type="text" class="form-control" placeholder="Your Name :" required="">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <select name="country" id="country" class="form-control" onchange="changeCode(this.value)" required="">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input name="yourContact" id="yourContact" type="text" class="form-control" placeholder="Contact No :" required="">
                                                </div> 
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    <label>Your Email <span class="text-danger">*</span></label>
                                                    <input name="yourEmail" id="yourEmail" type="email" class="form-control" placeholder="Your email :" required="">
                                                </div> 
                                            </div><!--end col-->
                                           <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    <label>Job Title <span class="text-danger">*</span></label>
                                                    <input name="jobName" id="jobName" type="text" class="form-control" placeholder="Your Job Title :" required="">
                                                </div> 
                                            </div><!--end col--> 
                                            <div class="col-md-12">
                                                <div class="form-group position-relative">
                                                    <label>Specific Requirements <span class="text-danger">*</span><br> (Please suggests the report you wish to enquire about)</label>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-center">
                                                <input type="submit" id="submit" name="send" class="btn btn-primary btn-block" value="Send Message">
                                            </div><!--end col-->
                                        </div><!--end row-->
                                    </form>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-12">
                    <h5 style="margin-top:30px;" class="rft-color1">FOR DIRECT INQUIRIES PLEASE CONTACT US AT:</h5> 
 
    <h5 style="margin-top:30px;" class="rft-color1">Address -</h5> 
 <?= $this->config->item('address');?><br>
<br>
                        <h5 style="margin-top:30px;" class="rft-color1">GET IN TOUCH WITH US:</h5> 

Email Id - <?= $this->config->item('email');?><br>
Contact No. <?= $this->config->item('mobile');?><br><br>
                        If you have any query, please contact us by writing an email at <a href="mailto:<?= $this->config->item('email');?>"><b><?= $this->config->item('email');?></b></a>. We'll get back to you asap.
                    </div>
                                           </div>
                                                                                                                                            </div>
