          ...
          <div class="banner-heading">
              <h1 class="banner-title">Contact Us</h1>
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?=base_url();?>contact">Contact Us</a></li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
...
<section id="main-container" class="main-container">
  <div class="container">
  <h3 class="section-sub-title text-center">Contact Us</h3>
    <div class="row">
    <div class="col-md-6 col-sm-6 col-lg-6 col-12 alert-primary p-5">
                    ...
                    <h5>FOR DIRECT INQUIRIES PLEASE CONTACT US AT:</h5> 
