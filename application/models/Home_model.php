	...
	*/
	...
	function deleteRecord($table,$arr)
	{
       if($this->db->delete($table, $arr))
           return TRUE; //array('id' => $id)
      return FALSE;
           
	}
    
   /* function deleteRecord($table,$arr)	{
   $delete = $this->db->delete($table, $arr); //array('id' => $id)
	}*/
	...
	public function getData($rowno,$rowperpage,$search="") {
		...
		if($search != ''){
		  $this->db->like('reportTitle', $search);
		  $this->db->or_like('publisherId', $search);
		}
	...
	public function fetch_reports($limit, $start) {
